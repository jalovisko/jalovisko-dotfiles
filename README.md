...
```bash
yay -S i3-gaps-rounded-git google-chrome polybar pulseaudio-control consolas-font nerd-fonts-hack picom-git pacaur libinput-gestures i3lock-color-git i3lock-fancy-multimonitor siji-git ntp bash-completion wal-telegram-git python-pywalfox
```
